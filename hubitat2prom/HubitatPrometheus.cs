...
public static class HubitatPrometheus
{
    const string INVALID_CHARACTER_REGEX = "[() -]";
    
    public static IEnumerable<HubitatDeviceMetricDetail> GetPrometheusDeviceMetrics(IEnumerable<HubitatDeviceDetails> hubitatDeviceDetails, string[] collectedMetrics)
    {
        ...
        foreach(var attribute in deviceDetail.attributes)
        {
            ...
            yield return new HubitatDeviceMetricDetail
            {
    ...
    public static IEnumerable<HubitatDeviceMetricDetail> GetPrometheusDeviceMetrics(IEnumerable<HubitatDeviceDetailSummary> hubitatDeviceDetails, string[] collectedMetrics)
    {
        foreach(var deviceDetail in hubitatDeviceDetails)
        foreach(var attribute in deviceDetail.attributes)
        {
